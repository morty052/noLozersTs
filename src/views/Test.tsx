...
import { TopicScreen } from "./gamemenu/components";
    ...
    <div className="min-h-screen bg-gradient-to-b  from-purple-900 to-gray-700">
      ...
      <div className="px-2 pt-14">
        ...
        <div className="absolute inset-x-0 bottom-4 flex justify-center ">
          <button className="inline-flex w-full max-w-md justify-center rounded-2xl border border-white p-2  shadow shadow-white">
